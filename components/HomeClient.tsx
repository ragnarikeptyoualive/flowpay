    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'No ID required, no data leaks',
          'Minimal data for smooth usage',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Aucun ID requis, aucune fuite de données',
          'Données minimales pour une utilisation fluide',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'لا حاجة إلى إثبات الهوية، ولا تسريب للبيانات',
          'سيتم طلب الحد الأدنى من البيانات لاستخدام سلس',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Sin verificación de identidad, sin filtración de datos',
          'Datos mínimos para un uso fluido',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Sem verificação de identidade, sem vazamento de dados',
          'Dados mínimos para uso fluido',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Không cần xác minh danh tính, không rò rỉ dữ liệu',
          'Dữ liệu tối thiểu cho trải nghiệm liền mạch',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Nessuna verifica dell\'identità, nessuna perdita di dati',
          'Dati minimi per un\'esperienza fluida',
        ],
      },
    },
    faq: {
    ...
    how: {
      ...
      rules: {
        ...
        items: [
          ...
          'Keine Identitätsprüfung, kein Datenverlust',
          'Minimale Daten für nahtloses Erlebnis',
        ],
      },
    },
    faq: {
